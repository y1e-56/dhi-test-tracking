...
const requireTaskManager = requireRole('chef_testeur', 'quality_manager', 'qa_lead', 'chef_projet');
const requireTaskAssignee = requireRole('chef_testeur', 'quality_manager', 'qa_lead', 'chef_projet', 'tester', 'developer');
